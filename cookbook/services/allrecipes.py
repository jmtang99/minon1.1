    ...
    try:
        ...
        for i in list1:
            ...
            try:
                ...
                print(1930910312039039120390123912039)
                print(other)
                # aa=list(models.CookbookIntroduce.objects.filter(baseid_id=i.id).values('tasteid__tastelabel'))[0]['tasteid__tastelabel']
            except Exception as ex:
                print('qwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww')
                print(ex)
                other={}
                other['efficacy']=''
